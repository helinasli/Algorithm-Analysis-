...
int main(int argc, char *argv[])
{
    ...
    if (verbose)
    {
        std::cout << "Searching for " << randomCity << "(" << colorArray[rbtNode->color] << ")"
                  << " with population " << testPopulation << std::endl;
    }
    // write the minimum and maximum values to the log file
    logFile << "Searching for " << randomCity << "(" << colorArray[rbtNode->color] << ")"
            << " with population " << testPopulation << std::endl;
    ...
    {
        logFile << "P"
                << "(" << colorArray[rbtParent->color] << "):" << rbtParent->name << ";";
        if (verbose)
        {
            std::cout << "P"
                      << "(" << colorArray[rbtParent->color] << "):" << rbtParent->name << ";";
    ...
    {
        logFile << "L"
                << "(" << colorArray[rbtLeft->color] << "):" << rbtLeft->name << ";";
        if (verbose)
        {
            std::cout << "L"
                      << "(" << colorArray[rbtLeft->color] << "):" << rbtLeft->name << ";";
    ...
    {
        logFile << "R"
                << "(" << colorArray[rbtRight->color] << "):" << rbtRight->name << ";";
        if (verbose)
        {
            std::cout << "R"
                      << "(" << colorArray[rbtRight->color] << "):" << rbtRight->name << ";";
    ...
    {
        std::cout << "Deleting "
                  << "a city with population " << testPopulation << std::endl;
    }
